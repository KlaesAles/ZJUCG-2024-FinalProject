...
float planeVertices[] = {
    ...
    -10.0f, -3.0f, -10.0f,  0.0f, -1.0f,  0.0f,  0.0f,  1.0f,
     10.0f, -3.0f, -10.0f,  0.0f, -1.0f,  0.0f,  1.0f,  1.0f,
     10.0f, -3.0f,  10.0f,  0.0f, -1.0f,  0.0f,  1.0f,  0.0f,
     10.0f, -3.0f,  10.0f,  0.0f, -1.0f,  0.0f,  1.0f,  0.0f,
    -10.0f, -3.0f,  10.0f,  0.0f, -1.0f,  0.0f,  0.0f,  0.0f,
    -10.0f, -3.0f, -10.0f,  0.0f, -1.0f,  0.0f,  0.0f,  1.0f,
};
...
int main()
{
    ...
    // Load shaders
    Shader lightingShader("./shader/shadow_light.vs", "./shader/shadow_light.fs");
    ...
    for (const auto& position : cubePositions) {
        angle += 20.0f;
        sceneObjects.emplace_back(cubeVAO, 36, position, glm::vec3(1.0f), glm::vec3(0.0f, angle, 0.0f));
    }
    ...
    for (const auto& position : pointLightPositions) {
        auto pointLight = std::make_shared<PointLight>(position, glm::vec3(0.4f));
        lightManager.addLight(pointLight);
    }

    // 初始化定向光
	auto dirLight = std::make_shared<DirectionalLight>(glm::vec3(-0.2f, -1.0f, -0.3f), glm::vec3(0.4f), 1.0f);
